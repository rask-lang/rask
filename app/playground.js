...
// The interpreter, under the build stamp. `?v=86ead06417af` is a placeholder the build
// replaces with the commit; both spellings have to stay identical wherever they
// appear, since the URL is the module-map key.
const WASM_GLUE = './pkg/rask_wasm.js?v=86ead06417af';
const WASM_BINARY = './pkg/rask_wasm_bg.wasm?v=86ead06417af';
