...
| Allgard | Federated platform — federation model (primitives, conservation laws, trust), Leden (wire protocol), Raido (verification VM). The whole stack. | [allgard/](projects/allgard/) |
| Midgard | Virtual world example — built on Allgard | [midgard/](projects/midgard/) |
