...
- Trait conformance is declared; inferred private bounds and duck traits match by shape, and the IDE shows inferred bounds and matching types as ghost text
