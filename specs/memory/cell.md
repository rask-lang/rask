...
| **CE4: with access** | Access through `with cell as v { ... }` — mutable binding, writes back at block exit |
| **CE5: Exclusive mutation** | `with...as v` takes exclusive access; no concurrent reads or writes |
