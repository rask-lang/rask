...
| **D8: Container slot allocation** | Which slot an insert takes, and a handle's generation | Deterministic function of the operation sequence. This is what a round trip preserves (`mem.relocatable/NP1`) and what a rack's `slot_index` records (`mem.racks/RK11`) |
