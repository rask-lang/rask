...
- **Panic interaction:** resolved by the proposed panic spec — panic point, message, and unwind order are deterministic and replay-stable (`ctrl.panic/PD1–PD3`). Closes when that spec is accepted.
