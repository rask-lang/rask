...
- [ ] **Panic unwinding (ctrl.panic)** — Panic path runs no ensures and aborts the process (#287); green-runtime join re-panics (#288); `staged()` unimplemented (#292). Ensure-cancellation definiteness analysis (#293–#296).
