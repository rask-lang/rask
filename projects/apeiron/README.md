...
3. **[Element table](ELEMENTS.md)** defines the thirteen elements (12 natural + 1 synthetic) — property vectors, abundances, starter recipes. Real-world names (iron, copper, uranium) for intuition. Seed-determined interaction physics for depth.
