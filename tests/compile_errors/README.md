...
| [while_presence_binding.rk](while_presence_binding.rk) | `while … ? as v` — refused at the form because no backend can bind per iteration; the `is` form works (#593, OPT19). Delete when it lands |
