...
impl std::fmt::Display for ErrorCategory {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ErrorCategory::Trait => write!(f, "Interface"),
    ...
    fn default() -> Self {
        ...
        Self {
            codes: register_codes! {
                ...
                // Trait errors (E07xx)
                "E0700" => ("interface bound not satisfied", Trait,
                ...
                "E0701" => ("missing interface method", Trait,
                ...
                "E0704" => ("conflicting interface methods", Trait,
...
// fix: let v: Vec<i64> = [1, 2, 3]"),
                ...
                "E0332" => ("Self-returning method called through an interface object", Trait,
                ...
                "E0333" => ("type doesn't implement the interface a bound requires", Trait,
...
let old = a.load(Ordering.SeqCst)"),
                ...
                "E0409" => ("one of the six auto-derived interfaces, declared by a package that doesn\'t own the type", Type,
                    ...
                    "// in `liba`, for a `Doc` that `traitpkg` declares\nextend traitpkg.Doc implements Hashable { … }   // error: only `traitpkg` can\n// fix: hash a type you own\ntype MyDoc = traitpkg.Doc\nextend MyDoc implements Hashable { … }"),
                ...
                "E0864" => ("a `match` on a type no set of arms can exhaust", Type,
                    ...
                    "match n {\n    1 => \"one\"\n    2 => \"two\"\n}                            // error: no arm for 3\n// fix: name the rest\nmatch n {\n    1 => \"one\"\n    2 => \"two\"\n    _ => \"many\"\n}"),
                "E0863" => ("`Error` is an interface, so it has no variants", Trait,
                ...
                "E0852" => ("a generic method can't be called through an interface object", Trait,
