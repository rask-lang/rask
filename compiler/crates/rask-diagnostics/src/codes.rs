        ...
        Self {
            codes: register_codes! {
                ...
                "E0314" => ("infinite type", Type,
                    "Inference found a type variable inside its own binding — solving it would need a type that contains itself forever. Usually an annotation somewhere in the chain settles it. For a *declaration* that contains itself, see E0886.",
...
let old = a.load(Ordering.SeqCst)"),
                ...
                "E0886" => ("recursive type has no size", Type,
