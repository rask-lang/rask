        ...
        Self {
            codes: register_codes! {
                ...
                "E0703" => ("unknown interface", Interface,
                    ...
                    "extend Point implements Printabel { }  // error: did you mean Printable?"),
...
let old = a.load(Ordering.SeqCst)"),
                ...
                "E0885" => ("a generic interface used with the wrong number of arguments", Type,
                    ...
                    "interface Scale<Rhs> {\n    func scale(self, k: Rhs) -> Self\n}\nextend Meters implements Scale { … }     // error: Scale takes 1 type argument, found 0\n// fix: say what it is\nextend Meters implements Scale<f64> { … }"),
