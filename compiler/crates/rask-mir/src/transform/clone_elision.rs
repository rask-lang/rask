...
mod tests {
    ...
    fn make_fn(blocks: Vec<MirBlock>) -> MirFunction {
        MirFunction {
            ...
            ret_ty: MirType::Void,
            locals: vec![
                MirLocal { id: local(0), name: Some("src".into()), ty: MirType::String, is_param: false, container: None },
                MirLocal { id: local(1), name: Some("dst".into()), ty: MirType::String, is_param: false, container: None },
                MirLocal { id: local(2), name: Some("tmp".into()), ty: MirType::I64, is_param: false, container: None },
                MirLocal { id: local(3), name: Some("other".into()), ty: MirType::String, is_param: false, container: None },
            ],
            blocks,
