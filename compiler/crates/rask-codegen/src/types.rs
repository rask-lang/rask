...
pub fn mir_to_cranelift_type(ty: &MirType) -> CodegenResult<Type> {
    match ty {
        ...
        MirType::FatPtr => Ok(types::I64), // Generic fat pointer
        MirType::String => Ok(types::I64), // String data pointer (ptr to null-terminated bytes)
...
pub fn mir_type_size(ty: &MirType) -> u32 {
    match ty {
        ...
        MirType::FatPtr | MirType::String => 16, // ptr + len
...
pub fn mir_type_alignment(ty: &MirType) -> u32 {
    match ty {
        ...
        MirType::I16 | MirType::U16 => 2,
        MirType::I32 | MirType::U32 | MirType::F32 | MirType::Char => 4,
        MirType::I64 | MirType::U64 | MirType::F64 | MirType::Ptr | MirType::FatPtr | MirType::String | MirType::FuncPtr(_) => 8,
