...
pub fn stdlib_entries() -> Vec<StdlibEntry> {
    let mut entries = vec![
        ...
        StdlibEntry {
            mir_name: "json_buf_new_array",
            c_name: "rask_json_buf_new_array",
            params: &[],
            ret_ty: Some(types::I64),
            can_panic: false,
        },
        StdlibEntry {
            mir_name: "json_buf_array_add_raw",
            c_name: "rask_json_buf_array_add_raw",
            params: &[types::I64, types::I64],
            ret_ty: None,
            can_panic: false,
        },
        StdlibEntry {
            mir_name: "json_buf_array_add_string",
            c_name: "rask_json_buf_array_add_string",
            params: &[types::I64, types::I64],
            ret_ty: None,
            can_panic: false,
        },
        StdlibEntry {
            mir_name: "json_buf_array_add_i64",
            c_name: "rask_json_buf_array_add_i64",
            params: &[types::I64, types::I64],
            ret_ty: None,
            can_panic: false,
        },
        StdlibEntry {
            mir_name: "json_buf_array_add_f64",
            c_name: "rask_json_buf_array_add_f64",
            params: &[types::I64, types::F64],
            ret_ty: None,
            can_panic: false,
        },
        StdlibEntry {
            mir_name: "json_buf_array_add_bool",
            c_name: "rask_json_buf_array_add_bool",
            params: &[types::I64, types::I64],
            ret_ty: None,
            can_panic: false,
        },
