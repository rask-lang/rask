...
//
// GENERATED — do not edit by hand. Unicode simple and special case
// mappings, taken from Rust's `char::to_uppercase`/`to_lowercase` so the
// native runtime answers what the interpreter does (the interpreter is the
// reference, and it is Rust's std). Regenerate with scripts/gen_unicode_case.
//
// Native case conversion used to be ASCII-only: `"a\u{f6}b".to_uppercase()`
// was `A\u{f6}B` and Greek was left alone entirely (#779).

#include "rask_runtime.h"

// The most a single scalar can grow, in bytes, under either mapping.
const int RASK_CASE_MAX_GROWTH = 3;

static const RaskCharRange RASK_ALPHABETIC[] = {
...
static const int RASK_ALPHABETIC_LEN = 761;

static const RaskCharRange RASK_NUMERIC[] = {
...
static const int RASK_NUMERIC_LEN = 146;

static const RaskCharRange RASK_LOWERCASE[] = {
...
static const int RASK_LOWERCASE_LEN = 677;

static const RaskCharRange RASK_UPPERCASE[] = {
...
static const int RASK_UPPERCASE_LEN = 660;

static const RaskCharRange RASK_CONTROL[] = {
    {0x0000,0x001F}, {0x007F,0x009F},
};
static const int RASK_CONTROL_LEN = 2;

static const RaskCaseSimple RASK_UPPER_SIMPLE[] = {
    ...
    {0x16E7D,0x16E5D}, {0x16E7E,0x16E5E}, {0x16E7F,0x16E5F}, {0x16EBB,0x16EA0},
    {0x16EBC,0x16EA1}, {0x16EBD,0x16EA2}, {0x16EBE,0x16EA3}, {0x16EBF,0x16EA4},
    {0x16EC0,0x16EA5}, {0x16EC1,0x16EA6}, {0x16EC2,0x16EA7}, {0x16EC3,0x16EA8},
    {0x16EC4,0x16EA9}, {0x16EC5,0x16EAA}, {0x16EC6,0x16EAB}, {0x16EC7,0x16EAC},
    {0x16EC8,0x16EAD}, {0x16EC9,0x16EAE}, {0x16ECA,0x16EAF}, {0x16ECB,0x16EB0},
    {0x16ECC,0x16EB1}, {0x16ECD,0x16EB2}, {0x16ECE,0x16EB3}, {0x16ECF,0x16EB4},
    {0x16ED0,0x16EB5}, {0x16ED1,0x16EB6}, {0x16ED2,0x16EB7}, {0x16ED3,0x16EB8},
...
static const int RASK_UPPER_SIMPLE_LEN = 1478;

static const RaskCaseSimple RASK_LOWER_SIMPLE[] = {
...
static const int RASK_LOWER_SIMPLE_LEN = 1487;

static const RaskCaseMulti RASK_UPPER_MULTI[] = {
...
static const int RASK_UPPER_MULTI_LEN = 102;

static const RaskCaseMulti RASK_LOWER_MULTI[] = {
    {0x0130, 2, {0x0069,0x0307,0x0000}},
};
static const int RASK_LOWER_MULTI_LEN = 1;
